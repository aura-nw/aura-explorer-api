...
import { ContractCodeParamsDto } from '../../../../components/contract-code/dtos/contract-code-params.dto';
...
describe('ContractCodeService', () => {
  ...
  describe('getContractCodes', () => {
    it('should retrieve Contract Codes info', async () => {
      ...
      const result = await contractCodeService.getContractCodes(
        {} as any,
        { keyword: '1' } as ContractCodeParamsDto,
      );
  ...
  describe('getContractCodeByCodeId', () => {
    it('when found contract code, should retrieve Contract Codes info', async () => {
    ...
    it('when not found contract code ,should return null', async () => {
  ...
  describe('updateContractCode', () => {
    ...
    it('when having exception, should throw error', async () => {
      const contractCodeResult = {
        code_id: 1,
        type: 'CW721',
      ...
      mockSmartContractCodeRepository('findOne', contractCodeResult);
      const mockHttp: any = Promise.reject('error');
      jest
        .spyOn(httpService, 'post')
        .mockImplementationOnce(() => of(mockHttp));

      try {
        await contractCodeService.updateContractCode({} as any, 1, {
          type: 'CW721',
        } as any);
      } catch (err) {
