...
export const INDEXER_API_V2 = {
  GRAPH_QL: {
    ...
    CW20_LIST_TOKEN: `query CW20ListToken($name: String, $address: String, $limit: Int, $offset: Int) { %s { cw20_contract(where: {_or: [{name: {_ilike: $name}}, {smart_contract: {address: {_eq: $address}}}]}, limit: $limit, offset: $offset) { %s } cw20_contract_aggregate(where: {_or: [{name: {_ilike: $name}}, {smart_contract: {address: {_eq: $address}}}]}) { aggregate { count } } } }`,
