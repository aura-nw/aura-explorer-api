...
export class removeDuplicateDelegations1652689008852 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_7ff3dbad33d546ab7cbee99ee2\` ON \`delegations\` (\`tx_hash\`, \`delegator_address\`, \`validator_address\`)`);
    }
