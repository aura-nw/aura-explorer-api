...
export class updateTokenInfoTableSmartContracts1662541463685 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`smart_contracts\` DROP COLUMN \`is_minted\``);
        await queryRunner.query(`ALTER TABLE \`smart_contracts\` DROP COLUMN \`num_tokens\``);
        await queryRunner.query(`ALTER TABLE \`smart_contracts\` DROP COLUMN \`token_symbol\``);
        await queryRunner.query(`ALTER TABLE \`smart_contracts\` DROP COLUMN \`token_name\``);
    }
