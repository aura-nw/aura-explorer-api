  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`asset\` (
				...
				\`coin_id\` varchar(255) NULL DEFAULT '',
				\`symbol\` varchar(255) NULL,
				\`name\` varchar(255) NULL,
				\`image\` varchar(255) NULL,
				\`current_price\` decimal(38,6) NULL DEFAULT '0.000000',
				\`price_change_percentage_24h\` float NULL DEFAULT '0',
				\`verify_status\` varchar(255) NULL,
				\`verify_text\` varchar(255) NULL,
				\`denom\` varchar(255) NULL,
				\`decimal\` int NULL DEFAULT '0',
				\`chain_id\` varchar(255) NULL,
				\`official_site\` varchar(255) NULL,
				\`social_profiles\` json NULL,
				\`type\` varchar(255) NULL,
				\`total_supply\` decimal(38,6) NULL DEFAULT '0.000000',
